...
def consumer_section_gui():
    frame = create_frame("Consumer Section")
    
    tk.Label(frame, text="Available Products", font=section_font, bg="white", fg="black").pack(pady=10)

    # Function to display products in the consumer section
    ...
    # Function to show farmer details on purchase button click
